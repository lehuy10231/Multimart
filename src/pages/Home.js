      ...
      <Row>
        <Col lg='6' md = '6'>
          <div className='content'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis libero tempore vitae error voluptatum minima ex provident ad voluptatibus? Quia.</p>
      ...
      <Container>
        <Row>
          <Col lg='6' md='6'>
            ...
            <Clock/>
            <button className='buy__btn store__btn'><Link to='/shop'>Vistit Store</Link></button>
          </Col>
